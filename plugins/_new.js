let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `FUTURE_MD-V2 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙎𝙐𝙋𝙋𝙊𝙍𝙏\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.com/channel/0029VacQFw65Ui2gGv0Kwk1r\n\n ${Config.botname} *©Danny*`;
...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*FUTURE_MD-V2 CURRENTLY ACTIVE!*";
